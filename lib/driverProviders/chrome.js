...
ChromeDriverProvider.prototype.teardownEnv = function() {
  var promises = [ this.driver_.quit() ];

  this.drivers_.forEach(function(driver) {
...
ChromeDriverProvider.prototype.getNewDriver = function() {
    var chromeDriverFile = this.config_.chromeDriver ||
        path.resolve(__dirname, '../../selenium/chromedriver');
...
ChromeDriverProvider.prototype.quitDriver = function(driver) {
  this.drivers_.splice(this.drivers_.indexOf(driver), 1)[ 0 ].quit();
};
